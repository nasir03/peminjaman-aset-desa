    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-lg-6 pt-4 pt-lg-0 content">
          ...
          <p>
            Aplikasi ini membantu desa dalam mengelola aset, proses peminjaman, dan pelaporan secara efisien dan digital.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            ...
            <h4><a href="#">Data Aset</a></h4>
            <p>Kelola aset secara terpusat dan transparan.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="icon-box">
            ...
            <h4><a href="#">Peminjaman</a></h4>
            <p>Peminjaman dan pengembalian aset yang terjadwal dan terdokumentasi.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
          <div class="icon-box">
            ...
            <p>Cetak laporan aset dan transaksi dalam format PDF.</p>
          </div>
        </div>
      </div>
    </div>
