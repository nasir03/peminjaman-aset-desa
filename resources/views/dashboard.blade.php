...
<head>
  ...
  <link href="{{ asset('back-end/img/logo/logo.png') }}" rel="icon">
  <title>RuangAdmin - Dashboard</title>
  <link href="{{ asset('back-end/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
  <link href="{{ asset('back-end/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
  <link href="{{ asset('back-end/css/ruang-admin.min.css') }}" rel="stylesheet">
</head>
...
<script src="{{ asset('back-end/js/ruang-admin.min.js') }}"></script>
